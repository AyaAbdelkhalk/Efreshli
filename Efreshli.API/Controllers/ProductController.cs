...
namespace Efreshli.API.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public ProductController(IProductService productService,ICloudinaryHelper cloudinaryHelper, IUnitOfWork unitOfWork)
        {
        ...
        //public static RawUploadParams ConvertToRawUploadParams(IFormFile file)
        //{
        //    var stream = file.OpenReadStream();
        //    return new RawUploadParams
        //    {
        //        File = new FileDescription(file.FileName, stream),
        //        PublicId = file.FileName // Optional: Set a custom public ID if needed
        //    };
        //}
        ...
        //    var apiKey = "sk-vN6r1orqJ6ytlAFKaRQewXd0mDtnR1rrM3Sa0s62bg3OhTrQ"; 
        ...
        //    var file = ByteArrayToFormFile(glbBytes, "model.glb");

        //    // Convert IFormFile to RawUploadParams
        //    var rawUploadParams = ConvertToRawUploadParams(file);

        //    // Uploading to Cloudinary
        //    var uploadResult = await _cloudinaryHelper.UploadRawAsync(rawUploadParams);
        //    var image = new Image() { PublicId=uploadResult.PublicId };
          
        //   var hh=  await _unitOfWork.ImageRepository.AddAsync(image);
        ...
        //    var glbBytes = await response.Content.ReadAsByteArrayAsync();
        //    var file = ByteArrayToFormFile(glbBytes, "jj");
        //   var uploaded=await  _cloudinaryHelper.UploadRawAsync(file);
        //    var image = new Image
        //    {
        //        URL = uploaded,
        //    };
