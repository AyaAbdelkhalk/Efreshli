        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrandCategory = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DelegatedPersonPosition = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    CommercialRegistrationAndTaxCard = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HasTax14 = table.Column<bool>(type: "bit", nullable: false),
                    HasElectronicInvoices = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FabricColorId = table.Column<int>(type: "int", nullable: true),
                    WoodColorId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductItems_Colors_FabricColorId",
                        column: x => x.FabricColorId,
                        principalTable: "Colors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductItems_Colors_WoodColorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductItems_FabricColorId",
                table: "ProductItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductItems_WoodColorId",
                table: "ProductItems",
                column: "WoodColorId");
